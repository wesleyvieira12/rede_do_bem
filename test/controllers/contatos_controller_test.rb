...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { email: @contato.email, message: @contato.message, name: @contato.name, phone: @contato.phone } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { email: @contato.email, message: @contato.message, name: @contato.name, phone: @contato.phone } }
